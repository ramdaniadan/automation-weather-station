  	...
  	<body>
		<table style="border-collapse: collapse">
			...
			<tr>
				...
				<th align="center"><div style="width: 60px">RainDaily</div></th>
				<th align="center"><div style="width: 60px">RainEvent</div></th>
				<th align="center"><div style="width: 60px">RainHourly</div></th>
				<th align="center"><div style="width: 60px">RainWeekly</div></th>
				<th align="center"><div style="width: 60px">RainMonthly</div></th>
				<th align="center"><div style="width: 60px">RainYearly</div></th>
				...
				<th align="center"><div style="width: 60px">UTimeStamp</div></th>
			</tr>
			</thead>
			<tbody>
...
<xsl:template match="Row">
	...
	<tr bgcolor="{$altColor}">
		...
		<td align="center"><div style="width: 60px"><xsl:value-of select="RainDaily"/></div></td>
		<td align="center"><div style="width: 60px"><xsl:value-of select="RainEvent"/></div></td>
		<td align="center"><div style="width: 60px"><xsl:value-of select="RainHourly"/></div></td>
		<td align="center"><div style="width: 60px"><xsl:value-of select="RainWeekly"/></div></td>
		<td align="center"><div style="width: 60px"><xsl:value-of select="RainMonthly"/></div></td>
		<td align="center"><div style="width: 60px"><xsl:value-of select="RainYearly"/></div></td>
		...
		<td align="center"><div style="width: 60px"><xsl:value-of select="UTimeStamp"/></div></td>
	</tr>
</xsl:template>
