  	...
  	<body>
		<table style="border-collapse: collapse">
			...
			<tr>
				...
				<th align="center"><div style="width: 60px">TempHi</div></th>
				<th align="center"><div style="width: 60px">TempLow</div></th>
				...
				<th align="center"><div style="width: 60px">RainRate</div></th>
				<th align="center"><div style="width: 60px">WindSpeed</div></th>
				<th align="center"><div style="width: 60px">WindRun</div></th>
				<th align="center"><div style="width: 60px">WindRose</div></th>
				<th align="center"><div style="width: 60px">Solar</div></th>
				<th align="center"><div style="width: 65px">SolarEnergy</div></th>
			</tr>
			</thead>
			<tbody>
...
<xsl:template match="Row">
	...
	<tr bgcolor="{$altColor}">
		...
		<td align="center"><div style="width: 60px"><xsl:value-of select="TempHi"/></div></td>
		<td align="center"><div style="width: 60px"><xsl:value-of select="TempLow"/></div></td>
		...
		<td align="center"><div style="width: 60px"><xsl:value-of select="RainRate"/></div></td>
		<td align="center"><div style="width: 60px"><xsl:value-of select="WindSpeed"/></div></td>
		<td align="center"><div style="width: 60px"><xsl:value-of select="WindRun"/></div></td>
		<td align="center"><div style="width: 60px"><xsl:value-of select="WindRose"/></div></td>
		<td align="center"><div style="width: 60px"><xsl:value-of select="Solar"/></div></td>
		<td align="center"><div style="width: 60px"><xsl:value-of select="SolarEnergy"/></div></td>
	</tr>
</xsl:template>
